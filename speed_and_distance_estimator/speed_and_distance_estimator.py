        ...
        for object_name, object_tracks in tracks.items():
            ...
            for frame_num in range(0, number_of_frames, self.frame_window):
                ...
                for track_id, _ in object_tracks[frame_num].items():
                    ...
                    # Use 'position' for starting and ending positions
                    start_position = object_tracks[frame_num][track_id]['position']  # Updated
                    end_position = object_tracks[last_frame][track_id]['position']  # Updated
