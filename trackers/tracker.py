        ...
        for object_name, object_tracks in tracks.items():
            for frame_num, track in enumerate(object_tracks):
                for track_id, track_info in track.items():
                    ...
                    # Set 'position' and 'position_transformed'
                    tracks[object_name][frame_num][track_id]['position'] = position
                    # Assuming you need to calculate the transformed position
                    tracks[object_name][frame_num][track_id]['position_transformed'] = position  # Replace with actual transformed position if needed
